...
5) I'm using some dodgy AndroidStudio version and build tools at the moment to enable Compose and Hilt and whatnot, so I dropped an apk in root in case you're having trouble building locally.
